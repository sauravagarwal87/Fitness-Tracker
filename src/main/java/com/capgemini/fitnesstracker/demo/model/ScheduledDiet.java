...
public class ScheduledDiet {
		...
		public ScheduledDiet() {
			super();
			
}

		public ScheduledDiet(User user, double day1Calorie, double day2Calorie, double day3Calorie, double day4Calorie,
		...
		@Override
		public int hashCode() {
			return Objects.hash(day1Calorie, day2Calorie, day3Calorie, day4Calorie, day5Calorie, day6Calorie,
					day7Calorie, user);
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			ScheduledDiet other = (ScheduledDiet) obj;
		...
		public String toString() {
			return "ScheduledDiet [user=" + user + ", day1Calorie=" + day1Calorie + ", day2Calorie=" + day2Calorie
